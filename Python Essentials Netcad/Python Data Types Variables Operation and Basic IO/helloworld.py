print('Hello World') # Function and string form part of the invocation
...
Experiment as much as you can. Change double quotes to single quotes, use multiple print()
...
# \ when used inside a string its called an escape character
