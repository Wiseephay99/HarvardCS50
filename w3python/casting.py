...
This can be done with casting. Python is an object-orientated language, and as such 
...
Casting in python is therefore done using constructor functions:
    ...
    a float literal (by removing all decimals), or a string literal (providing the 
